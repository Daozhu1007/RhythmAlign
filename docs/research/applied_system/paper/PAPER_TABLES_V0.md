...
| GCC-PHAT argmax | CORRECT_ACCEPT only | 10 | ms | 0.22 | 0.21–0.30 | 3.77 |
| GCC-PHAT argmax | All produced positive placements | 24 | s | 29.3135 | 0.0002–61.8948 | 184.1055 |
| NCC argmax | CORRECT_ACCEPT only | 19 | ms | 3.79 | 3.71–3.90 | 3.94 |
| NCC argmax | All produced positive placements | 24 | s | 0.0039 | 0.0037–0.0039 | 153.3829 |
...
| Condition | n | RhythmAlign v1.2.0 | GCC-PHAT argmax | NCC argmax | Panako OLAF |
| --- | --- | --- | --- | --- | --- |
...
| Source | Primary n | RhythmAlign v1.2.0 | GCC-PHAT argmax | NCC argmax | Panako OLAF |
| --- | --- | --- | --- | --- | --- |
...
| repeat01 vs final01 | GCC-PHAT argmax | ACCEPT → ACCEPT | Yes | 0.5651 | -0.04 | 61.894792 | 61.894833 |
| repeat01 vs final01 | Panako OLAF | ACCEPT → NO_MATCH | No | — | — | — | — |
| repeat01 vs final01 | NCC argmax | ACCEPT → ACCEPT | Yes | 0.5624 | +2.71 | 0.001250 | 0.003958 |
| repeat02 vs final02 | RhythmAlign v1.2.0 | ACCEPT → ACCEPT | Yes | 0.1161 | +14.03 | 0.005929 | 0.008096 |
| repeat02 vs final02 | GCC-PHAT argmax | ACCEPT → ACCEPT | Yes | 67.2049 | -67074.81 | 0.000208 | 67.075021 |
| repeat02 vs final02 | Panako OLAF | ACCEPT → NO_MATCH | No | — | — | — | — |
| repeat02 vs final02 | NCC argmax | ACCEPT → ACCEPT | Yes | 60.4599 | -60329.75 | 60.333667 | 0.003917 |
